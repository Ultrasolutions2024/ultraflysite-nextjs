...
import bg2 from "../images/blog/picture2.png";
import bg3 from "../images/blog/picture3.png";
import bg4 from "../images/blog/picture4.png";
import bg5 from "../images/blog/picture5.png";
import bg6 from "../images/blog/picture6.png";
import bg7 from "../images/blog/picture7.png";
import bg8 from "../images/blog/picture8.png";
import bg9 from "../images/blog/picture9.png";
import bg10 from "../images/blog/picture10.png";
import bg11 from "../images/blog/picture11.png";
import bg12 from "../images/blog/picture12.png";
          ...
          <div className="col-span-2 grid justify-center gap-2">
            ...
            <div className="max-w-4xl mx-auto p-6 space-y-6 bg-white rounded-lg shadow-md">
              <ol className="list-decimal pl-5 space-y-4 text-gray-700">
                ...
                <li className="text-lg md:text-xl font-semibold text-justify">
                  Leverage LinkedIn&apos;s unique features and engage meaningfully
                  with your network.
                </li>
              </ol>
            ...
            <div className="p-6 max-w-4xl mx-auto">
              ...
              <Image
                src={bg2}
                alt="Unlocking the Future"
                className="h-[30vh] object-cover md:h-[50vh] w-full rounded-md mt-4 mb-6"
              />
            ...
            <div className="p-6 max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                Sharing other&apos;s content will provide you with relationships and
                very much force your content out there. If you are sharing
                somebody else&apos;s work, the chances are they will reciprocate by
                showing your work to their audience.
              </p>
            </div>
