  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        <Link
          href="/careers/web"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] hover:bg-[#383bec] ease-in duration-200 hover:shadow-2xl hover:text-white "
        >
          Web Development
        </Link>
        ...
        <Link
          href="/careers/app"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] hover:bg-[#3c47da] ease-in duration-200 hover:shadow-2xl hover:text-white "
        >
          App Development
        </Link>
        ...
        <Link
          href="/careers/hr"
          className="text-[15px] font-bold border-solid border border-[#d7d7d7] py-[9px] px-[32px] rounded-[23px] hover:bg-[#3244df] ease-in duration-200 hover:shadow-2xl hover:text-white "
        >
          Human Resource
        </Link>
