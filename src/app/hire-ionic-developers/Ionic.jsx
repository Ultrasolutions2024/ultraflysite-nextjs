...
const Ionic = () => {
  ...
  const accordionData = [
    {
      question: "Why should I hire an Ionic developer from Ultrafly Solutions?",
      answer:
        "Our Ionic developers bring years of experience in building dynamic, scalable, and high-performing cross-platform applications. We focus on delivering secure and tailored solutions to fit your business needs.",
    },
    {
      question: "Can I hire an Ionic developer on a project basis?",
      answer:
    ...
    {
      question: "What type of applications can your Ionic developers build?",
      answer:
        "Our Ionic developers are skilled in creating custom mobile apps, enterprise-grade solutions, and hybrid applications. We cater to a wide range of industries and business sizes.",
    },
    {
    ...
    {
      question: "What’s the typical timeline for an Ionic project?",
      answer:
    ...
    {
      question: "How do I communicate with the Ionic development team?",
      answer:
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto py-10">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 w-3/4 mx-auto">
          Empower Your Business with Custom Ionic App Solutions
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-10">
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p className="font-medium group-hover:text-gray-100">
                  Develop tailor-made mobile applications that meet your unique
                  business needs, providing flexibility and optimal performance
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p className="font-medium group-hover:text-gray-100">
                  Build high-quality, cross-platform mobile apps using Ionic’s
                  powerful framework, ensuring a consistent experience across
                  devices
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p className="font-medium group-hover:text-gray-100">
                  Create scalable enterprise applications that streamline
                  operations, boost productivity, and enhance business
                  efficiency.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                <h3 className="text-xl font-semibold mb-3">
                  UI/UX Design for Ionic Apps
                </h3>
                <p className="font-medium group-hover:text-gray-100">
                  Enhance user engagement with intuitive, user-centric designs
                  that deliver seamless experiences on all platforms.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p className="font-medium group-hover:text-gray-100">
                  Develop powerful hybrid mobile applications that combine the
          ...
          >
            ...
            <div className="relative z-10 mx-auto max-w-md">
              ...
              <div className="space-y-6 pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
                ...
                <p className="font-medium group-hover:text-gray-100">
                  Keep your Ionic apps running smoothly with our ongoing
        ...
        <div className="grid sm:grid-cols-2 max-sm:gap-6">
          <div className="text-center p-6 flex flex-col justify-center items-center">
            <h3 className="font-extrabold text-2xl text-[#4e0083] leading-tight">
              Unleash the Power of Ionic Apps for Your Business!
            </h3>
            <p className="mt-4 text-lg text-gray-800">
              Looking for a custom Ionic solution that scales with your growing
              business? Get in touch with our expert team to discuss your
              project needs today.
            </p>
      ...
      <div className="py-10 max-md:px-10">
        ...
        <p className="mt-4 max-w-4xl mx-auto text-gray-600">
          Hiring an Ionic developer from Ultrafly Solutions means partnering
