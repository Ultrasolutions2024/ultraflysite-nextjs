        ...
        <div className="col-span-2 grid gap-2 ">
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-content">
              <p>
                At Ultrafly Solutions, our frontend developers bring years of
                expertise in delivering custom, responsive, and user-friendly
                solutions. We leverage the latest technologies and follow best
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-title text-xl font-medium">
              Can I hire a frontend developer on a project basis?
            </div>
            <div className="collapse-content">
              <p>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              What type of frontend services do you provide?
            </div>
            <div className="collapse-content">
              <p>
                We offer a wide range of frontend services, including custom
                development, responsive web design, SPA development, UI/UX
                design, and more.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do you ensure the performance of my frontend application?
            </div>
            <div className="collapse-content">
              <p>
                Our developers follow industry-standard optimization techniques,
                including code minification, lazy loading, and image
                optimization, to ensure fast load times and smooth performance.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do I communicate with the frontend development team?
            </div>
            <div className="collapse-content">
              <p>
