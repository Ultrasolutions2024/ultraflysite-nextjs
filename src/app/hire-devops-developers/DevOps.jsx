        ...
        <div className="col-span-2 grid gap-2 ">
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-title text-xl font-medium">
              Why should I hire a DevOps developer from Ultrafly Solutions?
            </div>
            <div className="collapse-content">
              <p>
                At Ultrafly Solutions, our DevOps developers bring years of
                expertise in delivering custom, automated, and scalable
                solutions. We leverage the latest technologies and follow
                industry best practices to ensure optimal performance.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-title text-xl font-medium">
              Can I hire a DevOps developer on a project basis?
            </div>
            <div className="collapse-content">
              <p>
                Yes! We offer flexible hiring models, including full-time,
                part-time, or project-based engagements, depending on your needs
                and budget.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              What type of DevOps services do you provide?
            </div>
            <div className="collapse-content">
              <p>
                We provide a wide range of DevOps services, including custom
                implementation, cloud infrastructure management, CI/CD
                pipelines, security automation, and more.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do you ensure the security of my infrastructure?
            </div>
            <div className="collapse-content">
              <p>
                Our DevOps developers follow industry-standard security
                protocols and best practices to secure your infrastructure. We
                also provide post-launch monitoring and maintenance to keep your
                systems safe.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              What is the typical timeline for a DevOps project?
            </div>
            <div className="collapse-content">
              <p>
                The timeline depends on the complexity and scope of your
                project. We provide a clear project plan with estimated
                timelines after discussing your specific requirements.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do I communicate with the DevOps development team?
            </div>
            <div className="collapse-content">
              <p>
                We prioritize transparent communication and provide direct
                access to your dedicated project manager and development team
                via email, calls, or collaboration tools to ensure smooth
                progress and updates throughout your project.
              </p>
            </div>
          </div>
        </div>
