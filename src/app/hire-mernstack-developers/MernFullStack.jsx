        ...
        <div className="col-span-2 grid gap-2 ">
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-content">
              <p>
                At Ultrafly Solutions, our MERN stack developers have years of
                experience in delivering custom, scalable web applications. We
                utilize the latest technologies and follow industry best
                practices to ensure optimal performance.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-title text-xl font-medium">
              Can I hire a MERN stack developer on a project basis?{" "}
            </div>
            <div className="collapse-content">
              <p>
                Yes! We offer flexible hiring models, including full-time,
                part-time, or project-based engagements, tailored to your needs
                and budget.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              What type of MERN stack services do you provide?
            </div>
            <div className="collapse-content">
              <p>
                We provide a wide range of MERN stack services, including custom
                application development, API integration, user interface design,
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do you ensure the performance of my application?
            </div>
            <div className="collapse-content">
              <p>
                Our MERN stack developers adhere to best practices in
                development and testing, ensuring your application is optimized
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              What is the typical timeline for a MERN stack project?
            </div>
            <div className="collapse-content">
              <p>
                The timeline varies based on the complexity and scope of your
                project. We provide a detailed project plan with estimated
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do I communicate with the MERN stack development team?
            </div>
            <div className="collapse-content">
              <p>
