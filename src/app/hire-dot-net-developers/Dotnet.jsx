        ...
        <div className="grid md:grid-cols-4 md:justify-between">
          ...
          <div className=" border-blue-600 border-b-[3px] max-md:border-r-[3px]">
            ...
            <div className=" md:h-[500px] lg:h-72 md:border-x-[3px] border-blue-600 p-10">
              <h1 className="text-xl font-bold">Build a Collaborative</h1>
              <p className=" ">
        ...
        <div className="col-span-2 grid gap-2">
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-title text-xl font-medium">
              Why should I hire a .NET developer from Ultrafly Solutions?
            </div>
            <div className="collapse-content">
              <p>
                At Ultrafly Solutions, we bring years of expertise in .NET
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            ...
            <div className="collapse-title text-xl font-medium">
              Can I hire a .NET developer on a project basis?
            </div>
            <div className="collapse-content">
              <p>
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              What type of applications can your .NET developers build?
            </div>
            <div className="collapse-content">
              <p>
                Our .NET developers have experience building a variety of
          ...
          <div className="collapse collapse-arrow bg-blue-100 border-blue-800 border-[2px]">
            <input type="radio" name="my-accordion-2" />
            <div className="collapse-title text-xl font-medium">
              How do I communicate with the .NET development team?
            </div>
            <div className="collapse-content">
              <p>
